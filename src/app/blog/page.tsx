...
const blogArticles = [
  {
    ...
    description: "Cannon Steels went from 23 Google reviews to 76 in four months using Grow Our Reviews. Here's exactly how they did it — and what it means for their Google visibility.",
