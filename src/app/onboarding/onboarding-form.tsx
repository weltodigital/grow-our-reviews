...
export function OnboardingForm() {
  ...
  // This page can keep the customer busy for several minutes while they
  // search for their business. Touch the session on mount so the browser
  // Supabase client schedules auto-refresh of the access token — otherwise
  // the token can silently expire before "Complete Setup" is pressed.
  useEffect(() => {
    if (!supabase) return
