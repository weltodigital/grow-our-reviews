...
export default function GoogleReviewResponseTemplatesTradesmen() {
  return (
    <div className="article-content">
      ...
      <h2>Why responding matters (even to good reviews)</h2>
      <p>
      ...
      <h2>How to respond to a 5-star review</h2>
      <p>
      ...
      <h3>Template 1: Short and sweet</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
        "Thanks for the kind words, [Name]! Really glad we could help with your [job type]. Much appreciated!"
      </blockquote>

      <h3>Template 2: Personal and specific</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h3>Template 3: Encouraging referrals</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <p>
        <strong>Important:</strong> Don't copy-paste the same reply to every 5-star review. Google can detect duplicate responses, and it looks lazy to customers. Vary your responses and keep them genuine.
      </p>

      <h2>How to respond to a 4-star review</h2>
      <p>
      ...
      <h3>Template 1: Acknowledge and improve</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h3>Template 2: Grateful and open to feedback</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h2>How to respond to a 3-star review</h2>
      <p>
      ...
      <h3>Template 1: Acknowledge and offer to discuss</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h3>Template 2: Professional and solution-focused</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <p>
        The framework that works: <strong>Acknowledge → Apologise for their experience → Offer to resolve offline → Keep it short</strong>
      </p>

      <h3>Template 1: When the complaint is valid</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h3>Template 2: When the complaint is exaggerated</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h3>Template 3: When you believe the review is unfair or fake</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <p>
        <strong>Remember:</strong> Future customers will judge you based on how professionally you respond to criticism. A calm, professional response to an unfair review can actually boost customer confidence.
      </p>

      <h2>How to respond to a review with no text (just a star rating)</h2>
      <p>
        Some customers leave star ratings without writing anything. Keep your response brief but acknowledge their time.
      </p>

      <h3>Template for star-only reviews</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
        "Thanks for the review, [Name]! Glad we could help with your [job type]. Much appreciated!"
      </blockquote>

      <h2>How to respond to a review that's clearly for the wrong business</h2>
      <p>
        This happens more often than you'd think. Be polite but clear that the review appears to be misdirected.
      </p>

      <h3>Template for wrong business reviews</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h2>Golden rules for all responses</h2>

      <h3>Always follow these principles:</h3>
      <ul className="my-8 space-y-4 leading-relaxed">
        <li><strong>Use the customer's name</strong> — shows you read their review personally</li>
        <li><strong>Respond within 24-48 hours</strong> — shows you're actively managing your business</li>
        <li><strong>Never argue publicly</strong> — even when you're 100% right, it looks unprofessional</li>
        <li><strong>Keep positive responses under 3 sentences</strong> — brief and genuine works best</li>
        <li><strong>Take negative conversations offline quickly</strong> — give your phone number and resolve privately</li>
        <li><strong>Include your trade or location naturally</strong> — mild SEO benefit when done tastefully</li>
        <li><strong>Stay consistent with your tone</strong> — friendly, professional, and helpful</li>
      </ul>

      <h3>Never do these things:</h3>
      <ul className="my-8 space-y-4 leading-relaxed">
        <li><strong>Respond in anger</strong> — wait 24 hours and calm down first</li>
        <li><strong>Get defensive</strong> — even if the customer is wrong</li>
        <li><strong>Write essays</strong> — keep responses concise</li>
        <li><strong>Use the same template repeatedly</strong> — Google and customers notice</li>
        <li><strong>Ignore reviews completely</strong> — responding shows you care</li>
        <li><strong>Ask for the review to be changed</strong> — customers don't like being asked to update reviews</li>
      </ul>

      <h2>What about really abusive reviews?</h2>
      <p>
      ...
      <ol className="my-8 space-y-4 leading-relaxed">
        <li>1. <strong>Report it to Google first</strong> — abusive reviews often get removed</li>
        <li>2. <strong>If Google doesn't remove it, respond very briefly:</strong> "Thanks for the feedback. Please call [number] if you'd like to discuss this properly."</li>
        <li>3. <strong>Don't engage with abuse</strong> — it never makes you look good</li>
      </ol>

      <h2>How responding helps your rankings</h2>
      <p>
