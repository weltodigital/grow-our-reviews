...
export default function BestTimeToAskForGoogleReview() {
  return (
    <>
      ...
      <p>Customer satisfaction follows a predictable pattern. It peaks at the moment the job is done and they can see the result. The hot water's flowing again. The lights are working. The kitchen looks brilliant.</p>

      <p>But that satisfaction fades quickly. Within 24-48 hours, they've moved on to other things. The problem you solved becomes normal again. The relief they felt disappears.</p>

      <p><strong>The window for getting a review is short. Miss it and it's gone.</strong></p>

      <p>This is why asking for a review three weeks later rarely works. They've forgotten how grateful they felt. The work you did has become part of their normal life, not something they're actively appreciative of.</p>

      <h2 id="best-time-ranked">The best time to ask (ranked)</h2>

      <p>Here are the most effective times to ask, from best to worst:</p>

      <h3>1. Two to four hours after the job (Winner)</h3>

      <p>This is the sweet spot. Satisfaction is still high, but they've had time to appreciate the work and settle back into their routine. They're not stressed about you still being in their house, and they're likely to have their phone nearby.</p>

      <p>If you finished a bathroom at 2pm, send the review request around 5-6pm. Perfect timing.</p>

      <h3>2. Same day, but later that evening</h3>

      <p>Still excellent timing. They've had the whole evening to use whatever you fixed and appreciate that it's working properly. People are often relaxed in the evening and more likely to take 30 seconds to help you out.</p>

      <h3>3. Next morning</h3>

      <p>Good, but starting to fade. It's still fresh in their memory, and most people check their phone first thing in the morning. A well-timed 9am text can work well.</p>
      ...
      <h3>5. More than 48 hours later</h3>

      <p>Effectiveness drops significantly. They're not thinking about your work anymore. They'll often ignore the message or mean to do it later and forget.</p>

      <p>Save yourself the effort. If you missed the 48-hour window, it's probably too late.</p>

      <h2 id="how-to-ask-in-person">How to ask in person (for those who prefer it)</h2>

      <p>If you want to ask face-to-face before you leave, keep it casual and confident:</p>

      <blockquote>
        <p>"If you're happy with the job, I'd really appreciate a quick Google review. It helps other people find us when they need [your trade]."</p>
      </blockquote>

      <p>That's it. Don't be pushy. Ask once, and if they say they'll think about it, leave it there.</p>
      ...
      <blockquote>
        <p>"Hi [customer name], glad we got your [specific job] sorted today. If you have a moment, a Google review would mean a lot to us: [your Google review link]"</p>
      </blockquote>

      <p><strong>Example:</strong><br />
      "Hi John, glad we got your bathroom radiator sorted today. If you have a moment, a Google review would mean a lot to us: https://g.page/mikesplumbing/review"</p>

      <h3>Template 3: The Personal Ask</h3>

      <blockquote>
        <p>"Hi [customer name], it's [your name] from [business name]. Really enjoyed working at yours today. If you're happy with the job, a quick Google review helps us a lot: [your Google review link]"</p>
      </blockquote>

      <p><strong>Example:</strong><br />
      "Hi Emma, it's Mike from Mike's Plumbing. Really enjoyed working at yours today. If you're happy with the job, a quick Google review helps us a lot: https://g.page/mikesplumbing/review"</p>
      ...
      <InternalLinkCTA
        text="Want this sent automatically after every job?"
        href="/pricing"
      ...
      <blockquote>
        ...
        <p>Hi [Name],</p>
        <p>Thank you for choosing us for your [specific job]. We hope you're delighted with the results.</p>
        <p>If you have a moment, we'd really appreciate a quick Google review. It helps other local customers find us when they need [your trade].</p>
        <p>You can leave a review here: [Google review link]</p>
        <p>Thanks again,<br />
        [Your name]<br />
        [Business name]</p>
      </blockquote>
      ...
      <p>Pestering customers damages relationships and can actually lead to negative reviews out of annoyance. If they haven't reviewed you after two polite requests, move on. Focus your energy on the next happy customer.</p>

      <h2 id="how-to-automate">How to automate the whole thing</h2>

      <p>Here's the problem with doing this manually: you're always thinking about the next job. You finish a bathroom, pack up your tools, drive to the next customer, and by evening you've forgotten to send that review request.</p>

      <p>It happens to everyone. Good intentions don't scale.</p>

      <p>This is why automation removes the human error problem entirely. The best systems work like this:</p>

      <ol>
        <li>Finish the job</li>
        <li>Enter the customer's name and number into your phone</li>
        <li>The system handles timing, message content, and follow-up automatically</li>
        <li>You focus on the next job</li>
      </ol>
      ...
      <p>Here's what to do after reading this:</p>
