...
export default function UnfairGoogleReviewTradesmanGuide() {
  return (
    <div className="article-content">
      ...
      <div className="callout-box mb-12">
        ...
        <ul className="space-y-2">
          <li>• Don't respond in anger — wait 24 hours and get a second opinion</li>
          <li>• Only about 10% of reported reviews get removed by Google</li>
          <li>• Your response isn't for the reviewer — it's for every future customer</li>
          <li>• The best defence against bad reviews is more good reviews</li>
        </ul>
      </div>

      <h2>First — don't respond in anger (seriously)</h2>
      <p>
      ...
      <p>
        <strong>Take 24 hours. Show a mate. Then come back and respond professionally.</strong>
      </p>

      <h2>Is the review actually against Google's policies?</h2>
      <p>
      ...
      <h3>What Google WILL remove:</h3>
      <ul className="my-8 space-y-4 leading-relaxed">
        <li><strong>Spam or fake reviews</strong> — from people who were never your customers</li>
        <li><strong>Hate speech or offensive language</strong> — reviews with swearing, threats, or discriminatory content</li>
        <li><strong>Reviews for the wrong business</strong> — clearly meant for a different company</li>
        <li><strong>Conflict of interest reviews</strong> — from competitors, employees, or people with a financial interest</li>
        <li><strong>Personal information</strong> — reviews that include phone numbers, addresses, or other private details</li>
      </ul>

      <h3>What Google WON'T remove:</h3>
      <ul className="my-8 space-y-4 leading-relaxed">
        <li><strong>Negative opinions</strong> — even if you disagree with them</li>
        <li><strong>Complaints about pricing</strong> — unless they include false claims</li>
        <li><strong>Bad experiences</strong> — if they genuinely used your service</li>
        <li><strong>One-sided stories</strong> — customers don't have to tell your side of events</li>
      </ul>

      <h3>How to report a review to Google:</h3>
      <ol className="my-8 space-y-4 leading-relaxed">
        <li>1. Go to your Google Business Profile</li>
        <li>2. Find the review and click the three dots next to it</li>
        <li>3. Select "Flag as inappropriate"</li>
        <li>4. Choose the reason that best matches</li>
        <li>5. Wait 5-14 days for Google's decision</li>
      </ol>

      <p>
        <strong>Set realistic expectations: Google removes about 10% of reported reviews.</strong> Don't rely on this as your only strategy.
      </p>

      <h2>How to respond to an unfair review professionally</h2>
      <p>
      ...
      <p>
        Here's the framework that works: <strong>Acknowledge → Apologise (for their experience, not admitting fault) → Offer to resolve offline → Keep it short</strong>
      </p>

      <h3>Template 1: Response to a genuine complaint where you made a mistake</h3>
      ...
      <h3>Template 2: Response to an exaggerated or unfair complaint</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h3>Template 3: Response to what you believe is a fake review</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <h3>Template 4: Response to a review that's clearly for the wrong business</h3>
      <blockquote className="my-8 py-6 px-8 rounded-lg">
      ...
      <p>
        <strong>The best defence against bad reviews is a steady stream of good ones.</strong>
      </p>
      ...
      <h2>FAQ — Your most common questions answered</h2>

      <h3>Can I sue someone for leaving a fake Google review in the UK?</h3>
      <p>
      ...
      <h3>How long does it take Google to remove a reported review?</h3>
      <p>
      ...
      <h3>Should I respond to every review, even good ones?</h3>
      <p>
      ...
      <h3>Can I pay to have a review removed?</h3>
      <p>
      ...
      <h3>What if the bad review is from someone I genuinely tried to help?</h3>
      <p>
